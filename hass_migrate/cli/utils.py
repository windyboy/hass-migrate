...
from hass_migrate.cli.constants import PROGRESS_FILE, TABLES, console, logger
from hass_migrate.cli.options import get_schema_name, get_schema_option
...
def register_utils_commands(app: typer.Typer) -> None:
    ...
    def tables():
        ...
        table_display = Table(
            title="Available Tables", show_header=True, header_style="bold cyan"
        )
        ...
        async def _run():
            ...
            try:
                ...
                status_table.add_column(
                    "PostgreSQL Rows", style="yellow", justify="right"
                )
                ...
                if all_match:
                    ...
                    console.print(
                        "[bold yellow]Some tables have row count mismatches.[/bold yellow]"
                    )
            finally:
                mysql_client.close()
    ...
    def progress():
        ...
        progress_table = Table(
            title="Migration Progress", show_header=True, header_style="bold cyan"
        )
