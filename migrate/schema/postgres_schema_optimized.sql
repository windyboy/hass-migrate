-- Home Assistant PostgreSQL Schema (Optimized)
...
-- Note: This is an optimized version with deferred foreign key constraints
-- for better migration performance. The base schema remains the same,
-- but constraints are created as DEFERRABLE to allow batch inserts.
...
-- Foreign Key Constraints (DEFERRABLE for better migration performance)
ALTER TABLE events
